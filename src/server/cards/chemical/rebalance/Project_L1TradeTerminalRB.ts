...
export class L1TradeTerminalRebalance extends Card {
  constructor() {
    super({
      name: CardName.L1_TRADE_TERMINAL_RB,
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.text('2').diverseTag().asterix().br;
          b.plainText('(Add a resource to 2 different cards.)').br;
        }),
      },
    });
  }
  ...
  public override bespokePlay(player: IPlayer): PlayerInput | undefined {
    ...
    return new SelectCard('Select 2 cards to gain 1 resource each', 'Add Resources', cards, {min: 2, max: 2})
      .andThen((cards) => {
        addResources(cards);
        return undefined;
      });
