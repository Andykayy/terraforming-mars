export enum CardName {
  ...
  HIRED_RAIDERS_UNDERWORLD = 'Hired Raiders:u',
    ...
    //andy own cards
    GHG_SHIPMENT_ANDY = 'GHG Shipment',
    ...
    CARBON_NANOSYSTEMS_RB = "Carbon Nanosystems(⚖)",
    CARTEL_RB = "Cartel(⚖)",
    CLOUD_SEEDING_RB = "Cloud Seeding(⚖)",
    COMMUNITY_SERVICES_RB = "Community Services(⚖)",
    CORPORATE_STRONGHOLD_RB = "Corporate Stronghold(⚖)",
    CUTTING_EDGE_TECHNOLOGY_RB = "Cutting Edge Technology(⚖)",
    CYBERIA_SYSTEMS_RB = "Cyberia Systems(⚖)",
    EARTH_CATAPULT_RB = "Earth Catapult(⚖)",
    ...
    HACKERS_RB = "Hackers(⚖)",
    HEAT_TRAPPERS_RB = "Heat Trappers(⚖)",
    INDUSTRIAL_CENTER_RB = "Industrial Center(⚖)",
    INSECTS_RB = "Insects(⚖)",
    JET_STREAM_MICROSCRAPPERS_RB = "Jet Stream Microscrappers(⚖)",
    L1_TRADE_TERMINAL_RB = "L1 Trade Terminal(⚖)",
    MARS_UNIVERSITY_RB = "Mars University(⚖)",
    MASS_CONVERTER_RB = "Mass Converter(⚖)",
    MEAT_INDUSTRY_RB = "Meat Industry(⚖)",
    ...
    ROTATOR_IMPACTS_RB = "Rotator Impacts(⚖)",
    SKY_DOCKS_RB = "Sky Docks(⚖)",
    SNOW_ALGAE_RB = "Snow Algae(⚖)",
    SOIL_FACTORY_RB = "Soil Factory(⚖)",
    SOLAR_LOGISTICS_RB = "Solar Logistics(⚖)",
    ...
    TOPSOIL_CONTRACT_RB = "Topsoil Contract(⚖)",
    ...
    VIRAL_ENHANCERS_RB = "Viral Enhancers(⚖)",
    WARP_DRIVE_RB = "Warp Drive(⚖)",
    ZEPPELINS_RB = "Zeppelins(⚖)",
    ...
    NITROGEN_SHIPMENT_RB = "Nitrogen Shipment(⚖)",
    ORBITAL_CONSTRUCTION_YARD_RB = "Orbital Construction Yard(⚖)",
    ...
    SPACE_CORRIDORS_RB = "Space Corridors(⚖)",
